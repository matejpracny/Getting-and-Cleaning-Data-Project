...
# Set directories and files location
...
# Remove parentheses and make syntactically valid names
...
# Make more understandable names
...
tidy_data_set <- ddply(sensor_data_mean_std, c("Subject","Activity"), numcolwise(mean))
